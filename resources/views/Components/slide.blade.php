...
<div class="mt-18 relative overflow-hidden group w-24/25 mx-auto rounded-4xl h-min" style="background:#060606;">
    ...
    <div class="slider-track py-12 group-hover:mt-16 group-hover:gap-12 duration-500 group-hover:border-y-4 border-y-white/10">
        {{-- erster Satz Bilder --}}
        @foreach($images as $image)
            <img src="{{ $image }}" alt="" class="rounded-xl mx-6 my-4 group-hover:scale-125 duration-500 ease-out">
        @endforeach
